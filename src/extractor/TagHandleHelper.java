...
public class TagHandleHelper {
    ...
    private static final String RESOURCE_TAG_FILE_EXTENSION = ".tag";
    ...
    public static boolean doExtract(String resourceFolderPath,
        ...
        if (!new File(exportFolderPath + RESOURCE_IMAGE_FOLDER_NAME).exists()) {
            FileUtils.createFolder(exportFolderPath + RESOURCE_IMAGE_FOLDER_NAME);
        }
        if (!new File(exportFolderPath + RESOURCE_TAG_FOLDER_NAME).exists()) {
            FileUtils.createFolder(exportFolderPath + RESOURCE_TAG_FOLDER_NAME);
        }
    ...
    private static String getTagFileNameByImageName(String imageName) {
        ...
        if (!TextUtils.isEmpty(extension)) {
            return fileName + "_" + extension + RESOURCE_TAG_FILE_EXTENSION;
        } else {
            return fileName + RESOURCE_TAG_FILE_EXTENSION;
        }
    }
